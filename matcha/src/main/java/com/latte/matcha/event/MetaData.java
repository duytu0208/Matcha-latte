...
public class MetaData {
    ...
    static {
        Card card1 = new Card();
        card1.setEnglishValue("Card01");
        Card card2 = new Card();
        card2.setEnglishValue("Card02");
        Card card3 = new Card();
        card3.setEnglishValue("Card03");
        Card card4 = new Card();
        card4.setEnglishValue("Card04");
    ...
    public void insertData() {
        ...
        cardTopic1.setCard(cards.get(0));
        cardTopic1.setTopic(topics.get(0));
